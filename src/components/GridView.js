        ...
        <GridWrapper>
          <div className="grid-view column">
            <div className="img-container">
              ...
              <div className="cart-icon icon" onClick={()=>dispatch(addtocart(gridview))}>
              <AiOutlineShoppingCart/>
              </div>
              <div className="view-icon ">
              <NavLink to={`/shop/${gridview.id}`} className="icon"  location={gridview}>
              <AiOutlineSearch/>
              </NavLink>
            ...
            <div className="grid-body">
              ...
              {/* <div className="p">Rating: {gridview.rating}</div> */}
