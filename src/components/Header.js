    ...
    <>
      <HeaderWraper>
        ...
        <div className={`header-container ${activatemenu} ${cartstatus}`}>
         ...
         <button type="button" onClick={()=>dispatch(opencloseMenu())} className="h3 btn mobile-btn"><RxHamburgerMenu/></button>
          <Nav/>
         </div>
         <Cart/>
        </header>
...
const HeaderWraper=styled.header`
    ...
    .nav .nav-link-item,.nav-register{
      color: ${({theme})=>theme.colors.firstcolor};
   ...
   .nav-link-item,.nav-register{
    ...
    /* .showmenu .nav .nav-order .nav-list,.showmenu .nav-icon{
      background:green; */
