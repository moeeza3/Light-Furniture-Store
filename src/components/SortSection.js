          ...
          <div className="sort-container">
            <div className="layout">
              <button className="layout-icon-grid layout-icon p">
                <RiLayoutGridFill
                  onClick={() => dispatch(changeLayout(true))}
                />
              </button>
              <button
                className="layout-icon-list layout-icon p"
                onClick={() => dispatch(changeLayout(false))}
              >
                <FaThList />
              </button>
            </div>
            <div className="count-show">
              ...
              {filterProducts.length >= 6 ? (
                <div>
                  <div>
                    Showing: <span>{filterProducts ? 1 : 0}</span>
                    <span> to </span>
                    {showingCount} of {filterProducts.length}
                  </div>
                </div>
              ) : (
                <div>
            ...
            <div className="select">
              <form>
                <select
                  name="sort"
                  id="sort"
                  className="p form-select sort-select"
                  onClick={(e) => {
