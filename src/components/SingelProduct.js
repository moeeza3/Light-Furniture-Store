        ...
        <div className="single-product">
          <div className="breadcrumb-container">
            ...
            <div className="breadcrumb h3">
              {loc.pathname.replaceAll("/", "").replace(singleData.id, "")}
          ...
          <div className="single-container">
            ...
            <div className="single-product-detail">
              ...
              <p className="single-rating single-common">
                Rating:{" "}
                <span>
                  <Star />
                </span>
              </p>
              <p className="single-status single-common">
                Status: <span>{singleData.status}</span>
              </p>
              <p className="single-category single-common">
                Category:{" "}
                <span>
                  {singleData.category ? singleData.category.name : "none"}
                </span>
              </p>

              <h2 className="single-price single-common">
              ...
              <div className="social-share">
                <div className="social-desc">Share this item:</div>
