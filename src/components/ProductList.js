...
import { filterData,shownoproducts,addproducts,displayProducts,updateFilterProducts } from '../store/slices/filterSlice'
...
const ProductList = ({apidata}) => {
  ...
  const {filterProducts,filters,grid,show}=useSelector(state=>state.filter);
  useEffect(()=>{
    ...
    <>
        ...
        <div className="shop-prod">
            ...
            <div className="show-products">
              <button onClick={()=>dispatch(addproducts(6))} className="show-more">Show More</button>
            </div>
            </div>
