          ...
          <div className="list-body">
            <div className="list-detail">
              ...
              <div className="list-para">
                {list.description && list.description.length>=120?list.description.slice(0,120).concat("..."):list.description}
              </div>   
            </div>
            <div className="list-cart">
                <div className="list-cart-container list-col">
                  <button type="button" className="add-to-cart p" onClick={()=>dispatch(addtocart(list))}>Add to Cart</button>
                </div>
                <div className="list-view-container list-col">
                  {/* <button type="button" className="view-product p">View Product</button> */}
                  
                  <button type="button" className="view-product p"><NavLink to={`/shop/${list.id}`}  location={list} className="link" >View Product</NavLink></button>
                </div>
            </div>
          </div>
        </div>
...
const ListWrapper=styled.div`
  ...
  /* .list-cart-container,.list-view-container{
    width: 45% !important;
    height: 50px !important;
