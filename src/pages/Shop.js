...
const Shop = () => {
   ...
   const {filterProducts,filters}=useSelector(state=>state.filter);
     ...
     <ShopWrapper>
      <div className="shop">
        ...
        <div className="tab-option">
            <button type="button" onClick={()=>dispatch(openclosefilter())} className="show-menu">Show Filter Menu</button>
        </div>
          <div className={`filter ${showfilter}`}>
          <div className="close-container">
          <button className="closemenu" onClick={()=>dispatch(openclosefilter())}>X</button>
          </div>
