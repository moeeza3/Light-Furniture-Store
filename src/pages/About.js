          ...
          <div className="about-container">
            <div className="about-row">
              <div className="about-col col-1">
                ...
                <p className="para-1">
                  Wodo is more than just an online furniture store. We hand pick
                  and curate the best in quality and style for you and your
                  home.Why spend days driving from store to store trying to find
                  that perfect look or unique piece. Find everything you’re
                  looking for and more from the comfort of your own home.
                </p>
                ...
                <p className="para-2">
                  ...
                  a complete at the system, expound the actual teachings of the
                  great of the truth, the human happiness was born. teachings of
                  the great of the truth
                </p>
              </div>
              ...
              <div className="unique-design col">
                ...
                <div className="choose-txt">
                  ...
                  <p>
                    ...
                    Quae impedit est ipsa quia dicta reprehenderit.
                  </p>
                </div>
              </div>
