      ...
      // },
       ...
       updateFilterProducts(state,action){
          ...
          if(price===0){
           ...
           console.log(sowingCount);

           
          //  if(!text){
          //    state.showingCount=action.payload;
          //  }else{
          //      state.showingCount=sowingCount;
          //  }    
          //  if(categories==="All"){
          //   state.showingCount=action.payload;
          //  }
       ...
       shownoproducts(state,action){
          ...
          // let sproduct=[...filterProducts];
            
          //   return{
          //     ...state,
          //     filterProducts:sproduct.slice(0,state.show)
          //   }
       },
      ...
      if(!text){
        state.showingCount=show;
         ...
         if(price===maxPrice){
          ...
          // console.log("Showing Count: "+action.payload)
      //  let {filterProducts,show}=state;
      //      console.log(show)
      //  let copydata=filterProducts;
        //  filterProducts=filterProducts.slice(0,show);
      //  return{
      //   ...state,
      //   filterProducts:copydata.slice(0,show)
      //  }
...
export const {filterApi,filterData,sorting,sortproducts,getInput,updateFilterProducts,clearfilters,shownoproducts,addproducts,changeLayout,displayProducts}=filterSlice.actions;
